...
import caseparticipantsController from "../../feature/case-participants/controller/case-participants.controller";
import { bindControllerMethods } from "../../utils/routes.util";

const router = Router();
const controller = bindControllerMethods(caseparticipantsController);
