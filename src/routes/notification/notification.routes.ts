...
import notificationController from "../../feature/notification/controller/notification.controller";
import { bindControllerMethods } from "../../utils/routes.util";

const router = Router();
const controller = bindControllerMethods(notificationController);
